...
router.post('', asyncHandler(async (req, res) => {
  ...
  if (processing.owner.department === undefined) delete processing.owner.department
  if (processing.owner.departmentName === undefined) delete processing.owner.departmentName
