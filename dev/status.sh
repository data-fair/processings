...
check_http "dev-api" "http://localhost:${DEV_API_PORT}/api/v1/_ping"
check_http "dev-ui" "http://localhost:${DEV_UI_PORT}"
check_tcp  "dev-worker-observer" "localhost" "${DEV_WORKER_OBSERVER_PORT}"
echo ""

# --- Docker compose services ---
echo -e "${BOLD}Docker compose services:${RESET}"
check_http "simple-directory" "${NGINX1}/simple-directory/"
check_http "data-fair" "${NGINX1}/data-fair/"
check_http "events" "${NGINX1}/events/"
check_http "openapi-viewer" "${NGINX1}/openapi-viewer/"
